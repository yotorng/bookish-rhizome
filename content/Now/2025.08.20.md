...
According to Wikipedia, a rhizome is "the main stem of the plant that runs underground...the plant uses the rhizome to store starches, proteins, and other nutrients."[^1]These nutrients are useful in an array of manners: to bear new life if the plant dies during winter, or if the rhizome is separated from the original plant.  
